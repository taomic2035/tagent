...
### 8.8 Step 8：Qwen3.5-9B 对比基准（2026-08-31）

| 指标 | 4B UD-Q4_K_XL | **9B UD-Q4_K_XL**（5966MB） |
|---|---|---|
| 生成 tg128（llama-bench，CPU 20 线程） | 11.89 tok/s | **8.39 tok/s**（4B 的 71%，好于带宽线性预期 44%） |
| prompt 处理 pp512 | 62.75 t/s | 42.85 t/s |
| 模型加载 | 3.4 s | 3.2 s |
